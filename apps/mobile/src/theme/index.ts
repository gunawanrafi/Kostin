// KostIn design tokens — React Native (Mobile Penyewa + Pemilik parity)
// Source: DESIGN_ANALYSIS_mob_penyewa.md / DESIGN_ANALYSIS_web_pemilik.md
// Kept in sync with apps/web/src/lib/design-tokens.ts — same token names & hex
// values, adapted per-platform only where the platform forces a difference
// (font-family strings, unitless radius/spacing numbers).
...
export const typography = {
  fontFamily: {
    // RN: use the exact PostScript/family name of the loaded font weight
    // (e.g. via @expo-google-fonts/rubik, @expo-google-fonts/inter).
    heading: 'Rubik',
    body: 'Inter',
    mono: 'Courier',
  },
